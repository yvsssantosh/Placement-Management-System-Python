  ...
  if(oldpas == self.opas):
   ...
   if(len(self.npas1) >= 6):
    ...
    if(self.npas1 == self.npas2):
     ...
     print("<h3 align='center'> Password Successfully Updated </h3>");
    ...
    print("<p align = 'center' style = 'color:red;'>Invalid Length of Password </p>");
     
  else:
  
   print("<p align = 'center' style = 'color:red;'>Invalid Old Password!! </p>");
