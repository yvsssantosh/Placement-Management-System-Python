...
try:
 ...
 cur.execute("create trigger trig4 delete on com_initial begin delete from com_criteria where cid=old.key1_email; delete from com_date where cid=old.key1_email; delete from stu_placed where cid=key1_email;end;");
